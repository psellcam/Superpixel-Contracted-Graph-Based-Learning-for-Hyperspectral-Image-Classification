 ...
 */
  ...
  __pyx_t_2 = PyInt_FromSsize_t(__pyx_v_cluster_number); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = PyInt_FromSsize_t(__pyx_v_cluster_number); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 20, __pyx_L1_error)
 ...
 */
            ...
            __pyx_t_18 = 1;
            if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_v_cluster_positions.shape[0];
            if (__pyx_t_18 < 0) __pyx_t_18 += __pyx_v_cluster_positions.shape[1];
            __pyx_t_19 = __pyx_v_j;
            __pyx_t_20 = 1;
            if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_v_cluster_positions.shape[0];
            if (__pyx_t_20 < 0) __pyx_t_20 += __pyx_v_cluster_positions.shape[1];
            __pyx_v_y_d = ((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_cluster_positions.data + __pyx_t_17 * __pyx_v_cluster_positions.strides[0]) )) + __pyx_t_18)) ))) - (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_cluster_positions.data + __pyx_t_19 * __pyx_v_cluster_positions.strides[0]) )) + __pyx_t_20)) ))));
 ...
 *     return distances
 */
            __pyx_t_21 = sqrt(__pyx_v_distance_mag);
            __pyx_t_22 = __pyx_v_i;
            __pyx_t_23 = __pyx_v_j;
            if (__pyx_t_22 < 0) __pyx_t_22 += __pyx_v_distances.shape[0];
            if (__pyx_t_23 < 0) __pyx_t_23 += __pyx_v_distances.shape[1];
            *((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_distances.data + __pyx_t_22 * __pyx_v_distances.strides[0]) )) + __pyx_t_23)) )) = __pyx_t_21;
            __pyx_t_24 = __pyx_v_j;
            __pyx_t_25 = __pyx_v_i;
            if (__pyx_t_24 < 0) __pyx_t_24 += __pyx_v_distances.shape[0];
            if (__pyx_t_25 < 0) __pyx_t_25 += __pyx_v_distances.shape[1];
            *((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_distances.data + __pyx_t_24 * __pyx_v_distances.strides[0]) )) + __pyx_t_25)) )) = __pyx_t_21;
          }
        }
      }
 ...
 *     # get dimensions
 */
  __pyx_tuple__19 = PyTuple_Pack(9, __pyx_n_s_cluster_positions, __pyx_n_s_cluster_positions, __pyx_n_s_cluster_number, __pyx_n_s_distances, __pyx_n_s_x_d, __pyx_n_s_y_d, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_distance_mag); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(1, 0, 9, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_graph_pyx, __pyx_n_s_create_distance_matrix, 13, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 13, __pyx_L1_error)
